...
class Addroof extends StatefulWidget {
 int index;
  ...
  List<String> colorroof = ['สีซิงค์', 'สีน้ำเงิน', 'สีเเดงมั่งมี','สีฟ้าทะเล','สีเเดงสด','สีเขียวสด','สีเขียวร็อคเก็ต','สีส้มเเสด','สีดำ','สีน้ำตาล','สีขาว','สีเทา','สีครีม','สีเหลือง','สีชมพู'];
