...
class Homepage extends StatefulWidget {
  const Homepage({super.key, required AuthenticationService auth, });
 ...
 int employeeCount = 10; 
  ...
  Widget build(BuildContext context) {
      ...
      appBar: AppBar(
        ...
        elevation: 2.5, // ตั้งค่า elevation เป็น 0.0 เพื่อป้องกันการปรากฎเงาด้านบน
        ...
        title: Row(
          children: [
       CircleAvatar(backgroundColor: const Color.fromARGB(255, 255, 255, 255),
            child: ClipOval(
              child: Image.network(
            ...
            Column(
              ...
              children: [
                ...
                Text(_auth.currentUser!.email.toString(),style: TextStyle(fontSize: 14,),), // ชื่อ
      ...
      drawer: Drawer(
              ...
              child: Image.asset(
                  "images/logoscaroen.png")),
                    ...
                    (backgroundColor: Color.fromARGB(31, 255, 255, 255),
                      child: Image.network("https://cdn-icons-png.flaticon.com/128/848/848043.png"),)
                    ],
                  ),
                   Row(
       ...
       floatingActionButton: FloatingActionButton(
        backgroundColor: const Color.fromARGB(255, 255, 255, 255),
          ...
          child: Icon(Icons.add,color: Color.fromARGB(255, 136, 135, 135),
          size: 40,
          ), // ไอคอนบวก
        ),
