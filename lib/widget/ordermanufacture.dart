                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => NextPage(
                                        ...
                                        lengthCover:snapshot.data![index].length_cover,
                                        colorRoof:snapshot.data![index].color_roof,
                                      ),
                                    ),
                                  );
                                },
...
class NextPage extends StatelessWidget {
  ...
  NextPage({Key? key, this.orderId,this.lengthCover,this.colorRoof}) : super(key: key);
